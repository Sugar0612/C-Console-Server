...
public class UserEvent : BaseEvent
{
    ...
    {         
        ...
        httpMethod.HttpSendAsync(pkg.Context, s_inf, EventType.UserEvent, OperateType.GET);
    }
    ...
    public override async void AddEvent(AsyncExpandPkg pkg)
    {
        ...
        httpMethod.HttpSendAsync(pkg.Context, body, EventType.UserEvent, OperateType.ADD);
    }
    ...
    public override async void ReviseInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        httpMethod.HttpSendAsync(pkg.Context, s_inf, EventType.UserEvent, OperateType.REVISE);
    }
    ...
    public override async void DeleteInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        string body = JsonMapper.ToJson(new_list);
        httpMethod.HttpSendAsync(pkg.Context, body, EventType.UserEvent, OperateType.DELETE);
    }
    ...
    public override async void SearchInfoEvent(AsyncExpandPkg pkg)
    {
        ...
        httpMethod.HttpSendAsync(pkg.Context, s_inf, EventType.UserEvent, OperateType.SEARCH);
        await UniTask.Yield();
    }
}